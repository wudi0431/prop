...
require(['wxms_config', 'jquery', 'dialog', 'jqui', 'qrcode'], function (WXMS_config, $) {
  ...
  var str = '<div data-project="%_id%" class="product_box">' +
    ...
    '<a href="javascript:;" class="iconfont preview list_project_btn" data-roe="preview" title="取消发布">&#xe606;</a>' +
    '<a href="javascript:;" class="iconfont editor list_project_btn" data-roe="editor" title="编辑">&#xe60a;</a>' +
    '</div>' +
    '<div class="product_ewm" data-preview="%preview%">' +
    '</div>' +
    '</div>' +
    '<div class="product_title">%description%</div>' +
    '<div class="product_date">发布状态：<span class="%prostatecolor%">%prostate%</span></div>' +
    '</div>';
      ...
      if (projectList.length > 0) {
        projectList.forEach(function (o, i) {
          ...
          var t = str.replace(/(%(\w+)%)/g, function ($1, $2, $3) {
            ...
            if ($3 == 'prostatecolor') {
              var stateclass="color_red";
              if(o.prostate!="0"){
                return stateclass='color_green';
              }
             return stateclass
            }
            return o[$3] ? o[$3] : '';
